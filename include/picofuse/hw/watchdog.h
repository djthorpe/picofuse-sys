 ...
 *
 * `hw_watchdog_reset()` arms a delayed reset without requiring additional
 * polling. The pending reset can be cancelled by calling
 * `hw_watchdog_enable()`.
 *
...
/**
 * @brief Trigger a delayed watchdog reset.
 * @ingroup Watchdog
 * @param watchdog Watchdog handle.
