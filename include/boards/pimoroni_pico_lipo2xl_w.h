...
// loads) note the SMSP mode pin is on WL_GPIO1
...
// If CYW43_WL_GPIO_VBUS_PIN is defined then a CYW43 GPIO has to be used to read
...
// PICO_VSYS_PIN) for other purposes. If this is the case, to use the VSYS GPIO
// it's necessary to ensure CYW43 is not using it. This can be achieved by
// wrapping the use of the VSYS GPIO in cyw43_thread_enter / cyw43_thread_exit.
